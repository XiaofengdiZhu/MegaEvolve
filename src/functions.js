import { global, save, message_logs, message_filters, webWorker, keyMultiplier, intervals, resizeGame, atrack , virtualTree } from './vars.js';
...
export function gameLoop(act){
    switch(act){
        ...
        case 'start':
            {
                let main_timer = global.settings.checkPeriod?global.settings.checkPeriod: 20;
                /*let mid_timer = 1000;
                let long_timer = 5000;
                if (global.race['slow']){
